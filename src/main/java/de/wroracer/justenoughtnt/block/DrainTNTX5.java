...
public class DrainTNTX5 extends BaseTNTBlock {

    private HashMap<BlockPos, DrainExplosion> explosions;

    public DrainTNTX5(Properties properties) {
    ...
    public void onExplode(BaseTNT tnt) {
        ...
        if (!explosions.containsKey(pos)) {
            explosions.put(pos, new DrainExplosion(tnt.getLevel(), pos, tnt.getOwner(), 100, 0.001D, 2D, 3000)); //max 3000 blocks per tick
        }
