...
public class BaseTNTRenderer<T extends BaseTNTBlock> extends EntityRenderer<TNTEntity> {
    ...
    public void render(TNTEntity tntEntity, float p_116178_, float p_116179_, PoseStack p_116180_, MultiBufferSource p_116181_, int p_116182_) {
        p_116180_.pushPose();
        ...
        p_116180_.popPose();
        super.render(tntEntity, p_116178_, p_116179_, p_116180_, p_116181_, p_116182_);
    }

    @Override
    public @NotNull ResourceLocation getTextureLocation(TNTEntity tntEntity) {
