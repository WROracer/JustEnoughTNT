...
public final class ModEntities {
        ...
        // lucky block tnt
        public static final RegistryObject<EntityType<LuckyBlockTNTEntity>> LUCKY_BLOCK_TNT = register(
                        "primed_lucky_blocks_tnt",
                        LuckyBlockTNTEntity::new,
                        MobCategory.AMBIENT,
                        (spawnEntity, level) -> new LuckyBlockTNTEntity(level, spawnEntity.getPosX(),
                                        spawnEntity.getPosY(), spawnEntity.getPosZ(), null));
        ...
        public static class Events {
                ...
                public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
                        ...
                        // lucky block tnt
                        event.registerEntityRenderer(LUCKY_BLOCK_TNT.get(),
                                        createEntityRenderer(ModBlocks.LUCKY_BLOCK_TNT.get()));
